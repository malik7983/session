...
async def sett(event):    
    ...
    async with Drone.conversation(event.chat_id) as conv: 
        xx = await conv.send_message("Send me any image for thumbnail as a `reply` to this message. @malik_bots")
        ...
        if not 'png' in mime:
            if not 'jpg' in mime:
                if not 'jpeg' in mime:
                    return await xx.edit("No image found. @malik_bots")
        await xx.delete()
        ...
        await t.edit("Temporary thumbnail saved! @malik_bots")
...
async def remt(event):  
    ...
    try:
        ...
        await event.edit("No thumbnail saved. @malik_bots")                        
